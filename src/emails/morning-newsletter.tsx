...
export const MorningNewsletter = ({
  username = 'Reader',
      ...
      <Body className="bg-gray-100 my-auto mx-auto font-sans">
        <Container className="max-w-2xl mx-auto my-8 bg-white rounded-lg shadow-lg overflow-hidden">
          ...
          <Section className="px-8 py-4">
            <Heading className="text-xl font-semibold text-gray-800">Today&apos;s Weather</Heading>
            <div className="bg-gray-50 rounded-lg p-4 flex items-center">
              <Img
                src={`${baseUrl}/static/weather-icon.png`}
                width="64"
                height="64"
...
MorningNewsletter.PreviewProps = {
  username: 'Sarah',
  date: 'June 15, 2023',
  topNews: [
    {
